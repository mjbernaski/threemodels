...
async def generate_and_open_html(json_file='data/conversations/conversation.json', html_file='public/comparisons/conversation_side_by_side.html'):
...
async def main():
    ...
    conversation = ConversationManager('data/conversations/conversation.json')
    ...
    while running:
        try:
            ...
            if user_input.lower() == 'exit':
                ...
                await generate_and_open_html('data/conversations/conversation.json', 'public/comparisons/conversation_side_by_side.html')
                print('Goodbye!')
                break
