...
def main():
    import sys
    conversation_file = sys.argv[1] if len(sys.argv) > 1 else 'data/conversations/conversation.json'
    output_file = sys.argv[2] if len(sys.argv) > 2 else 'public/comparisons/conversation.html'
